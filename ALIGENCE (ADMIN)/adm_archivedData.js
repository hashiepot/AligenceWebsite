...
function saveStudent(e) {
    ...
    if (editIndex !== null) {
        // Edit student
        students[editIndex] = { studentid, firstName, middleName, section };
    } else {
        // Add new student
        students.push({ studentid, firstName, middleName, section });
    }
...
function renderTable() {
    ...
    students.forEach((student, index) => {
        ...
        row.innerHTML = `
            ...
            <td>
                <span class="recover-icon" onclick="recoverStudent(${index})">🔄</span>
